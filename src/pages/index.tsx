...
// melhorar essa estrutura pois não faz muito sentido estar aqui e sim num componente
...
// carregar informações pelo lado do servidor (server side rendering)
// aqui é o next trabalhando (lado do servidor)
